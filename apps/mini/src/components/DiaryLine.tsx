...
export default function DiaryLine({
  ...
  return (
    <div className="relative group">
      {/* Korean 줄 */}
      <div className="relative flex items-center h-[26px] pl-[25px] pr-4 bg-transparent">
        <span
          className="whitespace-pre text-sm leading-[26px] invisible pointer-events-none select-none"
          aria-hidden="true"
        ...
        <textarea
          ...
          rows={1}
          style={{ fontFamily: font }}
          className="absolute inset-0 pl-[25px] pr-4 h-full resize-none bg-transparent outline-none text-sm text-foreground placeholder:text-foreground/25 leading-[26px] overflow-hidden"
        />
        {showDelete && (
          <button
      ...
      <div className="flex items-center h-[26px] pl-[25px] pr-4 bg-main">
        <p
          className={`flex-1 leading-[26px] text-xs whitespace-nowrap ${
